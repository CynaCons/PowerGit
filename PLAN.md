...
- [ ] Owner ticks: merge commit shows its diff in the diff view. Fixed 2123950f7 (spec tests/e2e/merge-diff.spec.ts green), awaiting owner verification. [agent: claude]
...
- [ ] Owner ticks: the checked-out branch's history stands out in the graph, and the bar switches scope and style. [agent: claude]
