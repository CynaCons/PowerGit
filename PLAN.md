...
### v0.15.6 — Ubuntu freeze taskforce — the main loop is alive, instrument what paints and let the owner drive recovery
...
### v0.15.7 — Presentation stall needs focus — v0.15.6 false alarms on Wayland (current) (ACTIVE)
...
- [ ] Owner ticks: no incident banner after hiding the window for a while on v0.15.7, and the Wayland week continues (the v0.15.6 owner tick carries over). [agent: claude]
