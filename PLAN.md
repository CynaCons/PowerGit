...
- [ ] Owner ticks: on GNOME, after launching the next AppImage once, the dock and Alt-Tab show the PowerGit icon (and a launcher entry exists).
- [ ] Owner ticks: the diff view, file lists and SHA column use the same face as the rest of the UI.
