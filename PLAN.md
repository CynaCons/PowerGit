...
- [ ] Gates: engine xunit on TempRepo for each scope and for --index --3way, vitest for the eligibility and label rules, e2e asserting the filesystem and the index rather than UI state, lint/tsc, packaged smoke test. [agent: claude]
