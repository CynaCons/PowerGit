...
export const CATALOG: CommandDef[] = [
  ...
  { id: "browse.openSettings", ge: "OpenSettings", scope: "browse", chord: chord(",", { ctrl: true }), available: true },
  { id: "browse.createBranch", ge: "CreateBranch", scope: "browse", chord: chord("B", { ctrl: true }), available: true },
  { id: "browse.createTag", ge: "CreateTag", scope: "browse", chord: chord("T", { ctrl: true }), available: true },
  { id: "browse.checkoutBranch", ge: "CheckoutBranch", scope: "browse", chord: chord(".", { ctrl: true }), available: true },
  { id: "browse.rebase", ge: "Rebase", scope: "browse", chord: chord("E", { ctrl: true, shift: true }), available: true },
  ...
  { id: "browse.quickFetch", ge: "QuickFetch", scope: "browse", chord: chord("ArrowDown", { ctrl: true, shift: true }), available: true },
  { id: "browse.quickPull", ge: "QuickPull", scope: "browse", chord: chord("P", { ctrl: true, shift: true }), available: true },
  { id: "browse.quickPush", ge: "QuickPush", scope: "browse", chord: chord("ArrowUp", { ctrl: true, shift: true }), available: true },
  { id: "browse.quickPullOrFetch", ge: "QuickPullOrFetch", scope: "browse", chord: chord("F8"), available: true },
  { id: "browse.stash", ge: "Stash", scope: "browse", chord: chord("ArrowUp", { ctrl: true, alt: true }), available: true },
  { id: "browse.stashPop", ge: "StashPop", scope: "browse", chord: chord("ArrowDown", { ctrl: true, alt: true }), available: true },
  { id: "browse.toggleLeftPanel", ge: "ToggleLeftPanel", scope: "browse", chord: chord("C", { ctrl: true, alt: true }), available: true },
  { id: "browse.focusLeftPanel", ge: "FocusLeftPanel", scope: "browse", chord: chord("0", { ctrl: true }), available: true },
  { id: "browse.focusRevisionGrid", ge: "FocusRevisionGrid", scope: "browse", chord: chord("1", { ctrl: true }), available: true },
  { id: "browse.focusCommitInfo", ge: "FocusCommitInfo", scope: "browse", chord: chord("2", { ctrl: true }), available: true },
  { id: "browse.focusDiff", ge: "FocusDiff", scope: "browse", chord: chord("3", { ctrl: true }), available: true },
  { id: "browse.focusFileTree", ge: "FocusFileTree", scope: "browse", chord: chord("4", { ctrl: true }), available: true },
  { id: "browse.focusNextTab", ge: "FocusNextTab", scope: "browse", chord: chord("Tab", { ctrl: true }), available: true },
  { id: "browse.focusPrevTab", ge: "FocusPrevTab", scope: "browse", chord: chord("Tab", { ctrl: true, shift: true }), available: true },
